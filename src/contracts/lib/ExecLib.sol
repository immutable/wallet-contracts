...
/// @title Passport Wallet V2 - ExecLib
/// @notice Library for execution utilities and helpers
/// @dev Provides utility functions for transaction execution and data handling

/// This file has been adapted from the Nexus suite, which can be found at: https://github.com/rhinestonewtf/nexus/blob/main/contracts/lib/ExecLib.sol

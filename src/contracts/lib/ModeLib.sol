...
/// @title Passport Wallet V2 - ModeLib
/// @notice Library for handling execution modes and call types
/// @dev Provides utilities for parsing and working with ERC-7579 execution modes

/// This file has been adapted from the Nexus suite, which can be found at: https://github.com/rhinestonewtf/nexus/blob/main/contracts/lib/ModeLib.sol

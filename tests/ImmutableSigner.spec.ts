...
describe('ImmutableSigner', () => {
    ...
    describe('isValidSignature', () => {
        ...
        it('Should return 0 for a random 16 byte signature', async () => {
            ...
            await expect(immutableSigner.isValidSignature(hash, randomBytes(16)))
                .to.be.revertedWith("SignatureValidator#recoverSigner: invalid signature length")
        })
        ...
        it('Should return 0 for a 0 byte signature', async () => {
            ...
            await expect(immutableSigner.isValidSignature(hash, []))
                .to.be.revertedWith("SignatureValidator#recoverSigner: invalid signature length")
        })
    })
